...
static int _scalerMultiplier = 4;
...
void System_SDL2::setupDefaultKeyMappings() {
	...
	addKeyMapping(SDL_SCANCODE_A,     SYS_INP_LEFT);
	addKeyMapping(SDL_SCANCODE_W,       SYS_INP_UP);
	addKeyMapping(SDL_SCANCODE_D,    SYS_INP_RIGHT);
	addKeyMapping(SDL_SCANCODE_S,     SYS_INP_DOWN);


	addKeyMapping(SDL_SCANCODE_SPACE,   SYS_INP_JUMP);
	addKeyMapping(SDL_SCANCODE_LSHIFT,    SYS_INP_RUN);
	addKeyMapping(SDL_SCANCODE_E,        SYS_INP_SHOOT);

	addKeyMapping(XINPUT_GAMEPAD_LEFT_THUMB,        SYS_INP_RUN);
